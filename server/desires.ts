...
function buildPrompt(
  ...
  return [
    ...
    "their perspective.",
    "",
    "This is a CONVERSION-FIRST DRAFT. Be emotionally sharp and honest about",
    "what the customer actually feels. A separate Compliance Check stage will",
    "later score and rewrite anything risky — so do NOT pre-sanitise here.",
    "",
    ...
    "- Allow emotionally uncomfortable truths.",
    "- Allow deeper insecurity, fear, frustration, status anxiety, regret,",
    "  embarrassment, and identity tension.",
    "- Do NOT over-soften the desire statements.",
    "- Surface the raw underlying motivation, not a polished version of it.",
    "",
    "Rules:",
    ...
    "- Keep each desire distinct and grounded in the real customer.",
    "",
    "Truthfulness safeguards (always apply):",
    "- Do NOT invent testimonials, studies, statistics, certifications, or guarantees.",
    "- Do NOT invent clinical proof or fabricate product claims.",
    ...
    "  do not let it suppress the strength of the desire.",
    "",
