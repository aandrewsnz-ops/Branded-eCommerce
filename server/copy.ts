...
function buildPrompt(
  ...
  return [
    "Generate a CONVERSION-FIRST QUICK COPY draft for testing ONE marketing angle",
    "on Meta/Facebook. This is NOT the full ad copy pack, and it is NOT meant to be",
    "publish-ready. The goal is to quickly judge whether the angle could strongly",
    "convert. A separate Compliance Check stage will later score and rewrite risky",
    "lines — so write the sharp version now, not the safe version.",
    "",
    "Use:",
    "- product details",
    ...
    "6. Five hooks.",
    "7. Three callouts.",
    "8. Up to three concise compliance notes (for the later Compliance Check stage).",
    ...
    "- Excessive compliance warnings inside the copy output",
    "",
    "Conversion-first style (encouraged):",
    "- Punchy hooks and direct, specific pain language.",
    "- Strong direct-response emotional framing — speak to the real feeling.",
    "- Do NOT force every line to be Meta-safe; that is the Compliance Check's job.",
    "- Natural language. Short paragraphs. Keep the output concise.",
    "- Use customer language patterns from research, but do not overquote sources.",
    "",
    "Truthfulness safeguards (always apply):",
    "- No fake testimonials. No fabricated studies, statistics, certifications,",
    "  or guaranteed results.",
    "- No invented clinical proof. No false product claims.",
    "- No claims that the product cures, treats, reverses, or permanently fixes",
    "  medical conditions, and no guaranteed transformation.",
    "",
    "Use our_product_name as the product name in the copy. Use current_offer",
    "and planned_sale_price where they strengthen the pitch (offer-led hooks,",
    "value framing, and CTAs are encouraged).",
    "",
    "Product context:",
