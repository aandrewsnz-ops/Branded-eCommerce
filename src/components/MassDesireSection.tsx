...
import { conceptSetForDesire, copySetForAngle } from "./workflow";
...
export function MassDesireSection({
  ...
  const hasConcepts = Boolean(conceptSet?.concepts?.length);
  ...
  return (
    <section className="strategy-desire-group">
      <header className="strategy-desire-header">
        ...
        <footer className="desire-card-footer">
          <div className="desire-card-actions">
            {hasConcepts ? (
              <span className="desire-badge desire-badge-concepts">3 Concepts</span>
            ) : null}
            <button
              type="button"
            ...
            >
              ...
              {isGeneratingTof ? "Generating…" : "Generate TOF Concepts"}
            </button>
            {hasConcepts && conceptSet ? (
              <button
                type="button"
